...
const gi = []
for (const o of countries1){
    //console.log(o)
    for (const p of o.languages)
    gi.push(p)
    //console.log(p)
}
console.log(gi)

const cantidadLang = gi.reduce((cont, nomb) => {
    cont[nomb] = (cont[nomb] || 0)+1
    return cont
}, {})

console.log(cantidadLang)
...
console.log('Cantidad de paises:',cont)
console.log(setC1,'Cantidad de lenguajes',setC1.size)
